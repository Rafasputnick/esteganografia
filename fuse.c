...
static int do_getattr(const char *path, struct stat *st) {
  ...
  // contents of the file. 		st_mode: 	Specifies the mode of the
  // file. This includes file type information (see Testing File Type) and the
  // file
  // permission bits (see Permission Bits). 		st_nlink: 	The number
  // of hard links to the file. This count keeps track of how many directories
  // have entries for this file. If the count is ever decremented to zero, then
  // the file itself is discarded as soon
